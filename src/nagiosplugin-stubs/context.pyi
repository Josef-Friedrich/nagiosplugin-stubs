...
from nagiosplugin.range import RangeSpec
...
class Context:
    ...
    def evaluate(self, metric: Metric, resource: Resource) -> Union[Result, ServiceState]: ...
    def performance(
...
class ScalarContext(Context):
    def __init__(
        self,
        name: str,
        warning: Optional[RangeSpec] = ...,
        critical: Optional[RangeSpec] = ...,
        fmt_metric: FmtMetric = ...,
        result_cls: Result = ...,
    ) -> None: ...
